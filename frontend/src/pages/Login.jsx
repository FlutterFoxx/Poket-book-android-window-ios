      ...
      <div className="w-full lg:w-[440px] flex flex-col justify-center px-8 py-12">
        <div className="max-w-sm mx-auto w-full">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-white/20 rounded-lg py-3 text-sm font-semibold text-white hover:bg-white/10 transition-colors mb-4"
          >
