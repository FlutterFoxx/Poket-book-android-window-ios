      ...
      <div className="w-full lg:w-[440px] flex flex-col justify-center px-8 py-12">
        <div className="max-w-sm mx-auto w-full">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-white/20 rounded-xl py-3 mb-4 text-sm font-semibold text-white hover:bg-white/10 transition-colors"
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs text-gray-600">or use email / phone</span>
            <div className="flex-1 h-px bg-white/10" />
          </div>
